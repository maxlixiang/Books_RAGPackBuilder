...
raw_data/textbook        -> textbook 模式，教材/教辅/章节目结构资料
raw_data/technical       -> technical 模式，技术书/工程书/手册
raw_data/paper           -> paper 模式，论文/研究报告/白皮书
raw_data/legal           -> legal 模式，法律/政策/制度/标准
raw_data/english         -> english 模式，英文书
raw_data/fiction         -> fiction 模式，小说/叙事文学
raw_data/classical       -> classical 模式，古籍/传统文献
raw_data/reference       -> reference 模式，词典/百科/条目型资料
```
